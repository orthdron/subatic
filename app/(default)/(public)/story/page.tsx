...
export default async function Page() {
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 bg-[#18181b] text-gray-200">
            <h1 className="text-4xl font-bold mb-6 text-blue-900">🎥 Hunt to find the cheapest way to host videos</h1>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">Could we have used Cloudflare CDN and stored the files on our own server and let Cloudflare cache it? Well, it might goes against their T&amp;C, plus I don&apos;t want to deal with servers as much as possible. 🚫</p>
            </section>
            ...
            <section className="mb-8">
                <h2 className="text-3xl font-bold mb-4 text-green-500">For self hosters.</h2>
                <ul className="list-disc list-inside mb-4">
                    <li>It is not necessary to use cloudflare r2, you can also use <a className="text-blue-500" href="https://github.com/minio/minio" target="_blank">minio</a> if you are hosting this in-house.</li>
                    <li>AWS can also be replaced with minio. minio supports webhook notifications to trigger transcoding pipelines.</li>
                </ul>
            </section>

            <section className="mb-8">
                <h2 className="text-3xl font-bold mb-4 text-green-500">Room for improvement?</h2>
                <ul className="list-disc list-inside mb-4">
                    <li>This project is missing ability to add subtitles, thumbnails and multi-audio streams.</li>
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc list-inside mb-4">
                    <li>This project is now open source for all. Feel free to self host or contribute or just raise bugs. <a className="text-blue-500" href="https://github.com/orthdron/subatic" target="_blank">Code Available here.</a> 📂</li>
